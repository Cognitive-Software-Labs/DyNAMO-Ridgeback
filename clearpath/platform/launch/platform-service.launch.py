...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/czika-stefania/Documents/DyNAMO/Code/DyNAMO-Ridgeback/clearpath/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/czika-stefania/Documents/DyNAMO/Code/DyNAMO-Ridgeback/clearpath'
                )
                ,
                (
                    'use_sim_time'
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'r100_0001/cmd_vel@geometry_msgs/msg/TwistStamped[gz.msgs.Twist'
                ,
                '/model/r100_0001/robot/cmd_vel@geometry_msgs/msg/TwistStamped]gz.msgs.Twist'
                ,
            ]
        ,
        remappings=
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/r100_0001/robot/tf@tf2_msgs/msg/TFMessage[gz.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/czika-stefania/Documents/DyNAMO/Code/DyNAMO-Ridgeback/clearpath/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
