...
Historical record only. The [current LiDAR contract](../isaac/lidar-pipeline.md)
supersedes the implementation claims as well as the invalidated measurements.
...
> ([port history](../isaac/port-history.md#lidars-detached-from-the-articulation-2026-09-11)). The
...
[`assets/slam-quality/`](../isaac/assets/slam-quality/).
...
![Run A: baseline on the broken sensor — starburst map, estimate stuck near origin](../isaac/assets/slam-quality/A_overlay.png)
...
![Run B: travel-gated slam params on the broken sensor — still destroyed](../isaac/assets/slam-quality/B_overlay.png)

![Run C: zero odometry noise on the broken sensor — still destroyed](../isaac/assets/slam-quality/C_overlay.png)
...
![FOV proof: configured 270° arc (green) vs measured returns (red) — left half empty](../isaac/assets/slam-quality/fov_proof.png)
...
![Run B5: full FOV but seamed scans — whole map slightly offset from GT](../isaac/assets/slam-quality/B5_overlay.png)

![Run B6: pair-consistent scans — ship state](../isaac/assets/slam-quality/B6_overlay.png)
...
![Run B3: right half tracked cleanly, then one bad loop closure folded the graph 7.4 m](../isaac/assets/slam-quality/B3_overlay.png)

![Run B4: best half-blind-era map — note the west-end trajectory excursion](../isaac/assets/slam-quality/B4_overlay.png)
...
![WINDOWED3: final full-loop run on the fixed sensor — RMSE 0.195 m](../isaac/assets/slam-quality/WINDOWED3_overlay.png)
...
![Analytic GT occupancy grid from mock_hospital.sdf](../isaac/assets/slam-quality/gt_hospital.png)
...
![Scan debug plot during bug 1: warped angular mapping](../isaac/assets/slam-quality/scan_debug.png)
