...
Commits `eaea0674` `70a5faa6` `e993ee29` `d26edef5` `0a81fbf6` `53a924a6`. Geometry drawing: `robot_geometry.svg` + `robot_render.png`. Full derivation and the measurement lessons: `port-history.md`.
