# Graph Report - /home/deivid/dev/DyNAMO-Ridgeback  (2026-05-06)

## Corpus Check
- Corpus is ~41,459 words - fits in a single context window. You may not need a graph.

## Summary
- 285 nodes · 540 edges · 15 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 154 edges (avg confidence: 0.78)
...
Cohesion: 0.16
Nodes (20): extract_public_estimator_values(), batch_from_detections_message(), batch_from_measurements_message(), build_detections_message(), build_measurements_message(), decode_optional_float(), first_finite_positive(), optional_float() (+12 more)
...
- **Thin community `Community 9`** (15 nodes): `G1OverlayNode`, `.color_callback()`, `.depth_callback()`, `.destroy_node()`, `.__init__()`, `.lidar_measurement_callback()`, `.log_warning_once()`, `.measurement_callback()`, `.measurement_message_key()`, `.merge_lidar_measurements()`, `.mono_depth_callback()`, `.render_callback()`, `.render_latest()`, `main()`, `g1_overlay_node.py`
