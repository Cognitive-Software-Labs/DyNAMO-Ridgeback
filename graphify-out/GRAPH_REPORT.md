# Graph Report - /home/deivid/dev/DyNAMO-Ridgeback/.claude/worktrees/jolly-borg-f48cab  (2026-07-10)

## Corpus Check
- 123 files · ~61,301 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 752 nodes · 1308 edges · 56 communities (40 shown, 16 thin omitted)
...
Cohesion: 0.07
Nodes (59): batch_from_detections_message(), batch_from_measurements_message(), build_detections_message(), build_float32_image_message(), build_measurements_message(), decode_bbox_quads(), decode_optional_float(), first_finite_positive() (+51 more)
...
Cohesion: 0.11
Nodes (11): extract_json_payload(), G1DistanceBenchmarkRunner, main(), build_summary_rows(), write_summary_csv(), write_trial_csv(), CompletedProcess, yaw_from_quaternion() (+3 more)
...
Cohesion: 0.14
Nodes (11): compute_iou(), non_maximum_suppression(), OwlV2Detector, parse_owl_detections(), Detection, G1DetectorNode, main(), Image (+3 more)
...
## Knowledge Gaps
- **136 isolated node(s):** `PreToolUse`, `allow`, `PreToolUse`, `build_and_start_expl.sh script`, `depth_hfov_deg` (+131 more)
...
- **Why does `G1DistanceBenchmarkRunner` connect `Community 3` to `Community 8`, `Community 4`, `Community 6`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `FrontierExplorerNode` connect `Community 2` to `Community 8`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `G1CameraMeasurementNode` connect `Community 10` to `Community 8`, `Community 1`?**
