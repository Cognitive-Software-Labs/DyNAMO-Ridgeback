...
Cohesion: 0.27
Nodes (12): add_planar_rig(), clearpath_package_paths(), generate_flat_urdf(), import_urdf_to_usd(), main(), package:// roots the URDF references, for the importer's resolver., # NOTE: app.close() fast-shuts the process — nothing after it runs., Append world -> px -> py -> rz -> base_link velocity-drive chain. (+4 more)
