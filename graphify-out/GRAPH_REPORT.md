...
## Corpus Check
- 174 files · ~91,868 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1279 nodes · 1926 edges · 80 communities (62 shown, 18 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 199 edges (avg confidence: 0.71)
...
Cohesion: 0.09
Nodes (14): parse_estimators(), selected_camera_estimators(), uses_camera_estimators(), uses_lidar_estimators(), BenchmarkCollageRenderer, PanelContext, RgbdOverlayRenderer, build_benchmark_nodes() (+6 more)
...
## Knowledge Gaps
- **460 isolated node(s):** `PreToolUse`, `allow`, `PreToolUse`, `isaac-sim-mcp`, `build_and_start_expl.sh script` (+455 more)
...
- **Why does `Time` connect `Community 8` to `Community 0`, `Community 35`, `Community 4`, `Community 36`, `Community 6`, `Community 12`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `G1DistanceBenchmarkRunner` connect `Community 0` to `Community 12`, `Community 5`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `FrontierExplorerNode` connect `Community 36` to `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 12`?**
