...
## Corpus Check
- 131 files · ~62,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 803 nodes · 1357 edges · 61 communities (44 shown, 17 thin omitted)
...
- `PanelContext` --uses--> `MeasurementEvent`  [INFERRED]
  src/ridgeback_autonomy/ridgeback_autonomy/benchmarking/rendering.py → src/ridgeback_autonomy/ridgeback_autonomy/benchmarking/alignment.py
- `MeasurementEvent` --uses--> `MeasurementEvent`  [INFERRED]
  src/ridgeback_autonomy/ridgeback_autonomy/benchmarking/rendering.py → src/ridgeback_autonomy/ridgeback_autonomy/benchmarking/alignment.py
...
- **Why does `G1DistanceBenchmarkRunner` connect `Community 4` to `Community 8`, `Community 11`, `Community 3`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `FrontierExplorerNode` connect `Community 2` to `Community 11`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `G1CameraMeasurementNode` connect `Community 10` to `Community 11`?**
