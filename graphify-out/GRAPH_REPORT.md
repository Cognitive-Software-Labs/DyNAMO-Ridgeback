# Graph Report - /home/samer/DyNAMO-Ridgeback  (2026-07-02)

## Corpus Check
- Corpus is ~49,064 words - fits in a single context window. You may not need a graph.

## Summary
- 723 nodes · 1297 edges · 48 communities (35 shown, 13 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 192 edges (avg confidence: 0.71)
...
Cohesion: 0.08
Nodes (33): batch_from_detections_message(), batch_from_measurements_message(), build_detections_message(), build_float32_image_message(), build_measurements_message(), decode_bbox_quads(), decode_optional_float(), first_finite_positive() (+25 more)

### Community 3 - "Community 3"
Cohesion: 0.11
Nodes (15): Enum, ExploreStatus, Marker, Odometry, _finite(), _get(), HumanoidParkingNode, main() (+7 more)
...
Cohesion: 0.09
Nodes (13): candidate_base_frames(), lookup_transform_components(), rotation_matrix_from_quaternion(), HudNode, main(), main(), VelocityOverlayNode, Node (+5 more)
...
- **Why does `G1DistanceBenchmarkRunner` connect `Community 6` to `Community 8`, `Community 17`, `Community 5`, `Community 14`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `FrontierExplorerNode` connect `Community 1` to `Community 8`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `HumanoidParkingNode` connect `Community 3` to `Community 8`?**
