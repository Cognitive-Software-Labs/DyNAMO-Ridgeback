"""Euclidean reconstruction -- deproject-then-aggregate (``docs/target_localization/euclidean_reconstruction.md``).
...
hierarchy, ``docs/target_localization/mask_representation.md`` Section 6.1); a mask with too few valid
...
from ridgeback_localization.core.mask import Mask, MaskPrecision
