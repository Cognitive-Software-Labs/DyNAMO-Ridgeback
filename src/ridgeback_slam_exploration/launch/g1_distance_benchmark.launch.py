...
def generate_launch_description():
    ...
    primary_metric = LaunchConfiguration('primary_metric')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('output_csv', default_value='/tmp/g1_rgb_distance_benchmark.csv'),
        ...
        DeclareLaunchArgument('primary_metric', default_value='rgb'),
