...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('output_csv', default_value='/tmp/g1_lidar_distance_benchmark.csv'),
        ...
        Node(
            ...
            executable='g1_detection_lidar_node',
            name='g1_detection_lidar',
            namespace=namespace,
            parameters=[{
        ...
        Node(
            ...
            name='g1_lidar_distance_benchmark_runner',
            namespace=namespace,
            parameters=[{
                'use_sim_time': use_sim_time,
                'world': world,
                ...
                'detection_topic': 'vlm/g1_detection_lidar',
                'primary_metric': 'lidar',
                'color_topic': color_topic,
